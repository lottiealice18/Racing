...
df = pd.read_csv('https://raw.githubusercontent.com/lottiealice18/Racing/main/1st%20July.csv')
...
def filter_rank():
    ...
    df_hist = pd.read_csv(r'https://raw.githubusercontent.com/lottiealice18/Racing/main/1st%20July.csv')
