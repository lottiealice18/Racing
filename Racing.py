...
df = pd.read_csv(r'https://raw.githubusercontent.com/lottiealice18/Racing/main/July%202nd.csv')
...
def filter_rank():
    ...
    df_hist = pd.read_csv(r'https://raw.githubusercontent.com/lottiealice18/Racing/main/July%202nd.csv')
